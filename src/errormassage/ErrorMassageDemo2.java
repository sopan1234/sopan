...
public class ErrorMassageDemo2 {
	...
	public void ErrorMassage() throws Exception {
		...
		String actual =wb.findElement(By.xpath(".//*[@id='view_container']/div/div/div[2]/div/div[1]/div/form/content/section/div/content/div[1]/div/div[2]/div[2]")).getAttribute("innerHTML");
